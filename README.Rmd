...
[![Last commit](https://img.shields.io/github/last-commit/devminka/rminka/master?style=flat-square)](https://github.com/devminka/rminka/commits/master)
[![GitHub release](https://img.shields.io/github/v/release/devminka/rminka?include_prereleases&sort=semver&label=version)](https://github.com/devminka/rminka/releases)
...
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](https://github.com/devminka/rminka/blob/master/inst/CODE_OF_CONDUCT.md)
...
*   `mnk_obs_update()`: Downloads observation data from the Minka API filtering by last update date
...
1. The main page directions is [rminka website](https://devminka.github.io/rminka/)

1. The starting web page is [rminka starting](https://devminka.github.io/rminka/articles/introduction-to-rminka.html)
