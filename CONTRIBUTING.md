...
This outlines how to propose a change to rminka. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("devMinka/rminka", fork = TRUE)`.
...
of Conduct](https://devminka.github.io/rminka/CODE_OF_CONDUCT.md). By
