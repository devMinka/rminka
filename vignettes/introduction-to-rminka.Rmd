...
The examples below show how the helper functions work. The first two use the *Torpedo torpedo* observations at the W Hotel breakwater from the previous sections. The last two use separate, specific examples.
